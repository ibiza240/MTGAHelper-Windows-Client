...
<img src="https://icon-library.net/images/important-icon-png/important-icon-png-1.jpg" width="16" /> **Important!** If you installed the preview7 version of the Microsoft .NET Core 3.0 framework (prior Sept. 24),<br />please refer to [this short guide to update it to the latest version](https://github.com/ibiza240/MTGAHelper-Windows-Client/blob/master/.NET%20Framework%20Upgrade%20Guide.MD) <img src="https://icon-library.net/images/important-icon-png/important-icon-png-1.jpg" width="16" />
