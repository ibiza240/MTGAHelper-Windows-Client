...
See [this explanation page](https://github.com/ibiza240/MTGAHelper-Windows-Client/blob/master/Console-on-macos.md) for more info on how to run the console program on MacOS.
